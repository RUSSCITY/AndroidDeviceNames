...
public class DeviceName {
    ...
    public static DeviceInfo getDeviceInfo(Context context, String codename, String model) {
        ...
        try (DeviceDatabase database = new DeviceDatabase(context, false)) {
            ...
            try (DeviceDatabase database2 = new DeviceDatabase(context, true)) {
                // do nothing, wait for second call
        ...
        return new
                ...
                DeviceInfo(null, null, codename, model); // unknown device
    }
